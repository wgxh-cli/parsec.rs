...
impl<'a, I: 'a, O1: 'a, O2: 'a, E: 'a> And<'a, I, O1, O2, E> {
  pub fn new(
...
pub struct AndFirst<'a, I, O1, O2, E> {
  first: &'a BoxedParser<'a, I, O1, E>,
  second: &'a BoxedParser<'a, I, O2, E>,
}
impl<'a, I, O1, O2, E> Parse<'a, I, O1, E> for AndFirst<'a, I, O1, O2, E> {
  fn parse(&self, context: I) -> ParseResult<I, O1, E> {
    And::new(self.first.caller(), self.second.caller()).map(|(first, _)| first).parse(context)
  }
}
